...
export const translations = {
  en: {
    ...
    // Survey page
    surveyTitle: "Adaptive Survey",
    surveySubtitle: "Test your knowledge across multiple categories. AI adapts to your strengths and weaknesses.",
    surveyInstructions: "Answer each question to the best of your ability. Your results will help shape future tests.",
  ...
  lv: {
    ...
    // Survey page
    surveyTitle: "Adaptīvā aptauja",
    surveySubtitle: "Pārbaudiet savas zināšanas dažādās kategorijās. AI pielāgojas jūsu stiprajām un vājajām pusēm.",
    surveyInstructions: "Atbildiet uz katru jautājumu pēc labākās sirdsapziņas. Rezultāti palīdzēs veidot nākamos testus.",
    startSurvey: "Sākt aptauju",
    questionProgress: "Jautājums {n} no {total}",
    nextQuestion: "Tālāk",
    finishSurvey: "Pabeigt",
    surveyResults: "Aptaujas rezultāti",
    overallScore: "Kopējais rezultāts",
    retakeSurvey: "Atkārtot aptauju",
